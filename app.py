    ...
    tools = [
        QueryEngineTool(
            ...
            metadata=ToolMetadata(
                ...
                description="Contains the Canadian Income Tax Act and CRA plain language guides covering income, deductions, credits, penalties, corporate tax, non-residents, and anti-avoidance provisions."
            )
        )
    ]
